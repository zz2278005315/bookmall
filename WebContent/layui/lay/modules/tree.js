            ...
            g.prototype.operate = function (e, a) {
                ...
                l.children(".layui-tree-btnGroup").on("click", ".layui-icon",
                    function (l) {
                        ...
                        if ("add" == f) {
                            //杨老师增加的控制代码
                            if (treeMethod != null && treeMethod.addChild != null) {
                                treeMethod["addChild"].call(x);
                            }
                            else {
                            ...
                            //杨老师增加的控制代码
                            if (treeMethod != null && treeMethod.updateChild != null) {
                                treeMethod["updateChild"].call(x);
                            }
                            else {
                            ...
                            //杨老师增加的控制代码
                            if (treeMethod != null && treeMethod.delChild != null) {
                                treeMethod.delChild(x);
                            }
                            else {
